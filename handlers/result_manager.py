from handlers.movie_handlers import handle_movies_with_no_match, handle_movies_with_multiple_matches
from handlers.series_id_handlers import handle_episodes_with_no_match, handle_episodes_with_multiple_matches
...
def get_handler(collected_results, api_client, interactive, ui):
    (
        movies_with_one_match,
        movies_with_multiple_matches,
        movies_with_no_match,
    ...
    if interactive:
        h1, s1, u1 = handle_movies_with_no_match(movies_with_no_match, api_client, ui)
        h2, s2, u2 = handle_movies_with_multiple_matches(movies_with_multiple_matches, api_client, ui)
        h3, s3, u3 = handle_episodes_with_no_match(episodes_with_no_match, api_client, ui)
        h4, s4, u4 = handle_episodes_with_multiple_matches(episodes_with_multiple_matches, api_client, ui)
